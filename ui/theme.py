...
# ══════════════════════════════════════════════════════════════════════════════
#  主题基础知识：
#  所有控件共用一套基础样式（边距、圆角、滚动条、菜单等），
#  具体颜色由 DARK_QSS 和 LIGHT_QSS 分别覆盖。
# ══════════════════════════════════════════════════════════════════════════════
...
# ══════════════════════════════════════════════════════════════════════════════
#  暗色主题（默认）
#  适合低光照环境，使用深蓝黑色背景+冷白色文字，减少视觉疲劳。
#  强调色为冷蓝色 #4a8cff，按钮、输入框焦点都使用此色。
# ══════════════════════════════════════════════════════════════════════════════
...
# ══════════════════════════════════════════════════════════════════════════════
#  亮色主题
#  适合高光照环境或用户偏好，浅灰色背景+深蓝灰文字。
#  强调色为亮蓝色 #3b82f6，与暗色主题的结构保持一致。
# ══════════════════════════════════════════════════════════════════════════════
